...
function SkeletonPublications() {
  return (
    <>
      <div className="mx-2 justify-center h-96 mb-4 bg-gray-300 p-5 border rounded shadow animate-pulse md:p-6 ">
        <div className="flex items-center mt-4 space-x-3 pb-6">
          <svg
...
export default SkeletonPublications;
